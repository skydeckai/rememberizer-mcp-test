...
Please note that `rememberizer-mcp-test` is currently in development and the functionality may be subject to change.
...
If you have SkyDeck AI Helper app installed, you can search for "Rememberizer" and install the rememberizer-mcp-test.
